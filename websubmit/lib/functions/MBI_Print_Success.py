...
def MBI_Print_Success(parameters, curdir, form, user_info=None):
    """
    This function simply displays a text on the screen telling the
    user that all the modifications of the corresponding blog record
    metadata went fine.
    ...
    t += Request_Print("A",  """<br /><br /><span style="padding-left:10px;"><b>Modification complete!</b></span><br /><br />""")
    if status == "APPROVAL":
