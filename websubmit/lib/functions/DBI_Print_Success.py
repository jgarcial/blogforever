...
def DBI_Print_Success(parameters, curdir, form, user_info=None):
    """
    This function simply displays a text on the screen telling the
    user that the order to delete a blog was received.
    ...
    t += Request_Print("A",  """<br /><br /><span style="padding-left:10px;"><b>Blog record deletion complete!</b></span><br /><br />""")
    if status == "APPROVAL":
    ...
    if status == "ADDED":
        t += Request_Print("A",  """<span style="padding-left:10px;">The blog record will be soon no longer available in our repository.</span>&nbsp;&nbsp;<br /><br />\n""")
