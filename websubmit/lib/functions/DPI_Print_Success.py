...
def DPI_Print_Success(parameters, curdir, form, user_info=None):
    """
    ...
    t += Request_Print("A",  """<br /><br /><span style="padding-left:10px;"><b>Post record deletion complete!</b></span><br /><br />""")
    if status == "APPROVAL":
        t += Request_Print("A",  """<span style="padding-left:10px;">An email has been sent to the referee.</span><br />""")
        t += Request_Print("A",  """<span style="padding-left:10px;">You will be warned by email as soon as the referee takes his/her decision regarding your post record.</span>&nbsp;&nbsp;<br /><br />""")
    if status == "ADDED":
        t += Request_Print("A",  """<span style="padding-left:10px;">The post record will be soon no longer available in our repository.</span>&nbsp;&nbsp;<br /><br />\n""")
