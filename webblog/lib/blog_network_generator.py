...
def get_blog_citation_network(marcXMLFile):
    """Generates a network of connected Blogs"""

    # Read the document tree
    tree = etree.parse(marcXMLFile)
...
def get_author_citation_network(marcXMLFile):
...
def get_author_cocitation_network(marcXMLFile):
    """Generates a network of connected Authors
...
# Execution part
#network = get_blog_citation_network('/Users/hendrikkalb/Documents/BlogForever-MARCXML/blog_export.xml')
#network = get_author_citation_network('/Users/hendrikkalb/Documents/BlogForever-MARCXML/blog_export.xml')
#network = get_author_cocitation_network('/Users/hendrikkalb/Documents/BlogForever-MARCXML/blog_export.xml')
#print write_CMXXML(network)
#print write_GEXF(network)